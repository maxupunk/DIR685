...
//+Space11072007 for Sync UPnPav's and iTune's DB
/* //mark by Space01222008
    system("cp -f /etc/mt-daapd.conf /mnt/HD_a4/");
    system("chmod 744 /mnt/HD_a4/mt-daapd.conf");
    system("cp -f /etc/upnpav.conf /mnt/HD_a4/");
    system("chmod 744 /mnt/HD_a4/upnpav.conf");
*/
    InitNASMediaFolder();
    writeDataToShm();
    system("echo $(pidof pure-ftpd) > /mnt/HD_a4/.systemfile/pidOfFTP"); // record the pid of fathor process of pure-ftpd
//Space11072007+
