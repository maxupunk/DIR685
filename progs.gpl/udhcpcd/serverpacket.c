...
#ifndef LOGNUM
		syslog(ALOG_NOTICE|LOG_NOTICE, "DHCP: Server sending OFFER of %s for static DHCP client.", inet_ntoa(addr));
#else
		syslog(ALOG_NOTICE|LOG_NOTICE, "NTC:020[%s]", inet_ntoa(addr));
#endif
