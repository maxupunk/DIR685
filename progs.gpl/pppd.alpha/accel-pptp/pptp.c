...
/* just for same as pptp options "sync pptp_sync" to avoid shell script modification. Actually not use by now */
static bool pptp_sync = 0; 
static int pptp_sync_extra = 0; 
static option_t Options[] =
{
    { "pptp_server_ip", o_string, &pptp_server,
      "PPTP Server" },
