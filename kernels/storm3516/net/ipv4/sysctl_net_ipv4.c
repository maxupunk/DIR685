 ...
 *
 * $Id: sysctl_net_ipv4.c,v 1.8 2008/05/07 01:26:09 wen_hsu Exp $
 *
...
ctl_table ipv4_table[] = {
	...
	{
                .ctl_name       = NET_TCP_STORLINK_ISCSI_TX_ACC,
                .procname       = "storlink_iscsi_tx_acc",
                .data           = &storlink_ctl.iscsi_tx_acc,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = &proc_dointvec,
        },	
	{
                .ctl_name       = NET_TCP_STORLINK_ISCSI_RX_ACC,
                .procname       = "storlink_iscsi_rx_acc",
                .data           = &storlink_ctl.iscsi_rx_acc,
                .maxlen         = sizeof(int),
                .mode           = 0644,
                .proc_handler   = &proc_dointvec,
        },
	{
		.ctl_name	= NET_TCP_STORLINK_NAPI,
		.procname	= "storlink_napi",
		.data		= &storlink_ctl.napi,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec,
	},
	// Fast NET, Michael Wu
	{
		.ctl_name	= NET_TCP_STORLINK_FAST_NET,
		.procname	= "storlink_fast_net",
		.data		= &storlink_ctl.fast_net,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec,
	},
	// HW VPN, Wen Hsu
	{
		.ctl_name	= NET_TCP_STORLINK_HW_VPN,
		.procname	= "storlink_hw_vpn",
		.data		= &storlink_ctl.hw_vpn,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec,
	},
	// HW Crypto from kernel, Wen Hsu
	{
		.ctl_name	= NET_TCP_STORLINK_HW_CRYPTO,
		.procname	= "storlink_hw_crypto",
		.data		= &storlink_ctl.hw_crypto,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec,
	},
