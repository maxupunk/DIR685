...
//+++ add by siyou 2009/1/16 10:40am.
#define NAT_SNAT_DNAT_ACTIONS  (NAT_ACTION_BITS | ACTION_SIP_BIT | ACTION_SPORT_BIT | \
												  ACTION_DIP_BIT |ACTION_DPORT_BIT)
//+++mark by siyou.
//if we have iptables use DNAT target, then the original definition will fail.
//because, in this case, we will need to do DNAT & SNAT.
//#define NAT_LAN2WAN_ACTIONS		(NAT_ACTION_BITS | ACTION_SIP_BIT | ACTION_SPORT_BIT)
#define NAT_LAN2WAN_ACTIONS		NAT_SNAT_DNAT_ACTIONS
...
#define NAT_WAN2LAN_ACTIONS		NAT_SNAT_DNAT_ACTIONS
