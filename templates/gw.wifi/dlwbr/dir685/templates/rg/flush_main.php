...
if (query("urlfilter") > 0 && query("webfilter")=="")
...
if ($wanif!="") { echo "iptables -t nat -A POSTROUTING -o ".$wanif.$MASQ_tcp_target."\n"; }
if ($wan2if!=""){ echo "iptables -t nat -A POSTROUTING -o ".$wan2if.$MASQ_tcp_target."\n"; }

if ($wanif!="") { echo "iptables -t nat -A POSTROUTING -o ".$wanif.$MASQ_udp_target."\n"; }
if ($wan2if!=""){ echo "iptables -t nat -A POSTROUTING -o ".$wan2if.$MASQ_udp_target."\n"; }
