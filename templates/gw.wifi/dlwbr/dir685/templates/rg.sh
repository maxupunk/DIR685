...
stop)
	...
	;;
flushall|macfilter|ipfilter|firewall|vrtsrv|dmz|passthrough|misc|portt|lanchange|wanup|blocking|arp_attack|policy|qos)
...
*)
	...
	echo "              arp_attack|policy|qos]" > /dev/console
	;;
esac
