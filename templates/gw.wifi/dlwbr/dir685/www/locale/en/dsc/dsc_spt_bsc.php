...
<div class="box">
<a name="wireless_setup"><h2>Wireless Setup</h2></a>
<table border=0 cellspacing=0 cellpadding=0>
<tr>
	<td height=20>
		<p>
...
<tr>
	<td height=20>	
 		<p>
 			<strong>Transmission (TX) Rates</strong><br>
...
<div class="box">
<a name="lan_setup"><h2>Network Setup</h2></a>
<table border=0 cellspacing=0 cellpadding=0>
<tr>
	<td height=20>
		<p>
...
<tr>
	<td height=20>
		<p>
			The LCD Setup page controls the settings of the display panel on your DIR-685 device.  This page allows you to control the screen saver and adjust the amount of time the device needs to be idle before the LCD Screen turns off.<br><br>
			<strong><em>Screen Saver Setting</em></strong> -
			The screen saver will display the "screen_bg.jpg" picture stored in the root directory of the internal hard drive in the background, with the current date and time moving randomly above the picture. If this picture cannot be found, the background will remain black. The "Timeout" setting indicates the amount of minutes required before the device enters screen saving mode, if left idle. The device will exit screen saver mode if any button on the Touch Pad is pressed.<br>
			<strong><em>Display Setting</em></strong> -
			This setting will turn off the LCD display screen to save power if the device is left idle for the amount of minutes configured in the "Timeout" field.  The LCD display screen will power on again if any of the Touch Pad buttons are pressed.<br>
		</p>
	</td>
</tr>
</table>
