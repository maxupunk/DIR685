...
if ($ACTION_POST!="")
{
	...
	$NEXT_PAGE=$MY_NAME;
	if($SUBMIT_STR!="" || $ONLY_DO_SUBMIT_STR!="")	{require($G_SAVING_URL);}
...
$admin_password=query("/sys/user:1/password");
...
function init()
{
	...
	f.grap_auth_enable.checked		= <? map("/sys/captcha","1","true",*,"false"); ?>;
	<?anchor("/security/firewall");?>
