...
function on_click_multicast_enable()
{
	...
	if(f.multicast_streams.checked)
		get_obj("id_multicast_streams_enhancement").style.display = "";
	else
		get_obj("id_multicast_streams_enhancement").style.display = "none";
}
