...
else
{
	...
	else if($ccode=="826"|| $ccode=="GB"|| $ccode=="UK")	{$ch_start=1;	$ch_end=13;}
	else if($ccode=="392"|| $ccode=="JP") 	{$ch_start=1;	$ch_end=13;}
	else if($ccode=="152"|| $ccode=="CL") 	{$ch_start=1;	$ch_end=13;}
	else									{$ch_start=1;	$ch_end=11;}
}
$INDEX=$ch_start;
while($INDEX<=$ch_end)
