...
else if ($ppp_type == "ppp3g")
{
	...
	*/
	...
	echo "echo ".$usb_modem_name." > /dev/console \n";
	...
	/* hendry add to open all 3G function in card */
	fwrite2($chat_file, "OK \\rAT+CFUN=1\n");
	...
	else
	{
	    ...
	    fwrite2($chat_file, "'' \\rAT^SYSINFO\n");
	    //polo
	    fwrite2($chat_file, "'' \\rAT+CGDCONT=1,\"IP\",\"".$ppp_apn."\"\n");
	}
