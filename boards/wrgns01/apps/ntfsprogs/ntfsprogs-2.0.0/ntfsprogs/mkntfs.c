...
int main(int argc, char *argv[])
{
	...
	utils_set_locale();
//	ntfs_log_info("mkntfs_init_options154545\n");
//fprintf(stderr,"mkntfs_init_options154545\n");
	mkntfs_init_options(&opts);			/* Set up the options */
//	ntfs_log_info("mkntfs_init_options\n");
//printf("mkntfs_init_options\n");
	if (!mkntfs_parse_options(argc, argv, &opts))	/* Read the command line options */
		goto done;
//	ntfs_log_info("mknt-------------------\n");	
//printf("mkntfs_parse_options\n");
