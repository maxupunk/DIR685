...
UPnPNode* get_unode_tail(UPnPNode *node)
{	
	UPnPNode *tail=NULL;
...
void serial_node_upnp(PacketNode *pnode, UPnPNode *node)
{							
...
void unserial_node_upnp(UPnPNode *node, PacketNode *pnode)
{		
