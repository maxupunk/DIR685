...
public:
    ...
    //RenderingControl
    NPT_Result Mute(PLT_DeviceDataReference& device, NPT_UInt32 instance_id, void* userdata);
    NPT_Result Volume(PLT_DeviceDataReference& device, NPT_UInt32 instance_id, int value,void* userdata);
