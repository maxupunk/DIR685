<?
/* vi: set sw=4 ts=4: */
fwrite("/dev/console", "Hello from hostapd.".$HAPD_interface.".conf\n");
...
///* If use the default socket, we need not to assign the following unix socket names. */
//if ($USE_DEF_SOCKET!=1)
//{
//	fwrite2($HAPD_conf, "wps_mc_unixsocket=/var/run/wps_mc_usock_".$HAPD_interface."\n");
//	fwrite2($HAPD_conf, "wps_eap_unixsocket=/var/run/wps_inbeap_usocket_".$HAPD_interface."\n");
//	fwrite2($HAPD_conf, "wps_wlan_unixsocket=/var/run/wps_inbwlan_usocket_".$HAPD_interface."\n");
//}
/* Generate WPS config */
if ($HAPD_wps==1)
{
	...
	fwrite2($HAPD_conf, "wps_bcnie_filename=/var/run/wps_inbwlan_beaconie\n");
	fwrite2($HAPD_conf, "wps_prbrspie_filename=/var/run/wps_inbwlan_proberespie\n");
...
//		fwrite2($HAPD_conf, "rsn_preauth_interfaces=".$HAPD_interface."\n");
	}
	else
	{
